...
for library in libraries["MediaContainer"]["Directory"]:
    ...
    if library["title"] == "Movies":
        ...
        movie_library_content=list_plex_library_content(movie_library_id,"all")
        for movie in movie_library_content["MediaContainer"]["Metadata"]:
           ...
           if item_metadata_label != None:
                print(item.get("MediaContainer").get("Metadata")[0].get("title"))
                item_metadata_label_id=str(item_metadata_label[0].get("id"))
                print(item_metadata_label)
                print(item_metadata_label_id)
...
print(len(movie_library_content_metadata))
print(movie_library_content_metadata[0])